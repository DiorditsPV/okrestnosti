...
def main():
    ...
    page = '''<!doctype html><html lang="ru"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Зодчество — все плакаты</title><style>
...
</style></head><body><header><div class="eyebrow">Зодчество · Московская серия</div><h1>Места и истории района</h1>'''
