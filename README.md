# Окрестности — московская серия плакатов
...
- [Домодедовская — Авангард, скейтеры и 2007 год](posters/domodedovskaya-orekhovo-borisovo/04-avangard-2007/README.md)
- [Домодедовская — Водолей](posters/domodedovskaya-orekhovo-borisovo/03-vodoley-fix/README.md)
...
| 05 | Авангард | 2007 год, скейтеры, Linkin Park, Limp Bizkit и веселье |
...
Агент должен просмотреть фотографию и выбрать 1–2 подходящих финальных плаката из `output/`, затем передать сами изображения инструменту генерации вместе с фото. Для светлой советской стилистики базовый ориентир — Моссовет (`*02-mossovet-positive*`); для эстетики 1994–2000 — Водолей (`*03-vodoley-fix*`), для скейтерского 2007-го — Авангард (`*04-avangard-2007*`). Фото задаёт архитектуру и композиционные особенности места, плакаты — палитру, рисовку и настроение. Их надписи и здания не нужно копировать.
